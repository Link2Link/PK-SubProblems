function [theta, is_LS]  = PKsub_Q4(h, p, k, d)
% subproblem.sp_4  Subproblem 4: Circle and plane
% This code base on https://github.com/rpiRobotics/ik-geo.git
...
if norm_A_2 > b^2
    ...
    theta = [atan2(x_ls_tilde(1), x_ls_tilde(2)), atan2(x_ls_tilde(1), x_ls_tilde(2))];
    is_LS = true;
end
